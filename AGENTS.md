...
- Design system: follow the `daaysorn-design-system` skill at `public/doc/daaysorn-design-system/SKILL.md` (https://github.com/daaysorn/daaysorn/blob/main/public/doc/daaysorn-design-system/SKILL.md). Deep reference: `public/doc/designSystem.md`; runtime tokens: `app/globals.css`.
